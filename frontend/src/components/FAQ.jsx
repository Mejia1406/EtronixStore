      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <details
              key={index}
              className="group rounded-2xl backdrop-blur-xl bg-gradient-to-br from-white/15 to-white/5 border border-white/20 shadow-lg hover:shadow-xl hover:shadow-cyan-500/20 transition-all duration-300 overflow-hidden"
            >
              <summary className="cursor-pointer list-none p-6 flex items-center justify-between hover:bg-white/5 transition-colors">
                ...
                <svg
                  className="w-6 h-6 text-cyan-400 transition-transform duration-300 group-open:rotate-180 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        {/* CTA de contacto */}
        <div className="mt-12 text-center backdrop-blur-xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-400/30 rounded-2xl p-8">
